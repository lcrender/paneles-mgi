...
export default function TiposPage() {
  return (
    <>
        ...
        headline={
          <>
            ...
            <p className="mx-auto mb-12 max-w-2xl text-center text-lg text-gray-600">
              Más abajo compará los núcleos aislantes (PIR, EPS, Lana de Roca) y las especificaciones
              generales.
            </p>
          </>
        }
      />
      <PanelProductSectionDivider />
      <PanelTrapezoidalSection variant="techos" />
      <PanelProductSectionDivider />
      <PanelMuroSection />
      <PanelProductSectionDivider />
      <PanelEcoTrapezoidalSection />
